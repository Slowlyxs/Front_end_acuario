    ...
    return (
        <div className="container mx-auto px-6 py-12 bg-gray-50 min-h-screen">
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-gray-800 mb-6">Nuestros Productos mas adquiridos</h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center max-w-6xl mx-auto">
                <div className="card bg-base-100 w-80 shadow-sm hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="card-body">
                        <h2 className="card-title">Goldfish</h2>
                        <div className="mb-2">
                            <Calificacion rating={5} />
                        </div>
                        <p className="text-gray-600 mb-4">El goldfish es un pez de agua dulce muy popular, conocido por su color brillante y cuerpo robusto. Es tranquilo, resistente y necesita un espacio adecuado para crecer sano.</p>
                ...
                <div className="card bg-base-100 w-80 shadow-sm hover:shadow-lg transition-shadow duration-300">
                    <figure>
                        <img
                            src="./imagenes/goldfishmasconocida.png"
                            className="w-full h-48 object-cover"
                        />
                    </figure>
                    <div className="card-body">
